...
var grammar = {
    ...
    {"name": "unsigned_int", "symbols": ["unsigned_int$ebnf$1"], "postprocess": function(d) {return parseInt(d[0].join(""));}},
    ...
    {"name": "int", "symbols": ["int$ebnf$1", "int$ebnf$2"], "postprocess": function(d) {if (d[0]) {return parseInt(d[0][0]+d[1].join(""));} else {return parseInt(d[1].join(""));}}},
    ...
    {"name": "unsigned_decimal", "symbols": ["unsigned_decimal$ebnf$1", "unsigned_decimal$ebnf$2"], "postprocess": function(d) {return parseFloat(d[0].join("") +(d[1] ? "."+d[1][1].join("") : ""));}},
    ...
    {"name": "decimal", "symbols": ["decimal$ebnf$1", "decimal$ebnf$2", "decimal$ebnf$3"], "postprocess": function(d) {return parseFloat((d[0] || "") +d[1].join("") +(d[2] ? "."+d[2][1].join("") : ""));}},
    {"name": "percentage", "symbols": ["decimal", {"literal":"%"}], "postprocess": function(d) {return d[0]/100;}},
    ...
    {"name": "jsonfloat", "symbols": ["jsonfloat$ebnf$1", "jsonfloat$ebnf$2", "jsonfloat$ebnf$3", "jsonfloat$ebnf$4"], "postprocess": function(d) {return parseFloat((d[0] || "") +d[1].join("") +(d[2] ? "."+d[2][1].join("") : "") +(d[3] ? "e" + (d[3][1] || "+") + d[3][2].join("") : ""));}},
    ...
    {"name": "dstrchar", "symbols": [{"literal":"\\"}, "strescape"], "postprocess": function(d) {return JSON.parse("\""+d.join("")+"\"");}},
    {"name": "sstrchar", "symbols": [/[^\\'\n]/], "postprocess": id},
    {"name": "sstrchar", "symbols": [{"literal":"\\"}, "strescape"], "postprocess": function(d) { return JSON.parse("\""+d.join("")+"\""); }},
    {"name": "sstrchar$string$1", "symbols": [{"literal":"\\"}, {"literal":"'"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "sstrchar", "symbols": ["sstrchar$string$1"], "postprocess": function(d) {return "'"; }},
    {"name": "strescape", "symbols": [/["\\\/bfnrt]/], "postprocess": id},
    {"name": "strescape", "symbols": [{"literal":"u"}, /[a-fA-F0-9]/, /[a-fA-F0-9]/, /[a-fA-F0-9]/, /[a-fA-F0-9]/], "postprocess": function(d) {return d.join("");}},
    ...
    {"name": "FORM_PROPERTIES$subexpression$1", "symbols": ["TARGET"]},
    ...
    {"name": "TARGET$subexpression$1", "symbols": [/[tT]/, /[aA]/, /[rR]/, /[gG]/, /[eE]/, /[tT]/], "postprocess": function (d) {return d.join(""); }},
    {"name": "TARGET$ebnf$1", "symbols": [/./]},
    {"name": "TARGET$ebnf$1", "symbols": ["TARGET$ebnf$1", /./], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "TARGET", "symbols": ["_", "TARGET$subexpression$1", "__", "TARGET$ebnf$1", {"literal":"\n"}], "postprocess": function(d){return {key:"target", value:d[3].join("")}}},
    ...
    {"name": "FIELD_PROPERTIES$subexpression$1", "symbols": ["READONLY"]},
    {"name": "FIELD_PROPERTIES$subexpression$1", "symbols": ["DISABLED"]},
    {"name": "FIELD_PROPERTIES$subexpression$1", "symbols": ["ACCEPT"]},
    ...
    {"name": "TYPE$subexpression$2$subexpression$17", "symbols": [/[aA]/, /[dD]/, /[dD]/, /[rR]/, /[eE]/, /[sS]/, /[sS]/, {"literal":"-"}, /[gG]/, /[oO]/, /[oO]/, /[gG]/, /[lL]/, /[eE]/], "postprocess": function (d) {return d.join(""); }},
    {"name": "TYPE$subexpression$2", "symbols": ["TYPE$subexpression$2$subexpression$17"]},
    {"name": "TYPE$subexpression$2$subexpression$18", "symbols": [/[aA]/, /[dD]/, /[dD]/, /[rR]/, /[eE]/, /[sS]/, /[sS]/], "postprocess": function (d) {return d.join(""); }},
    {"name": "TYPE$subexpression$2", "symbols": ["TYPE$subexpression$2$subexpression$18"]},
    {"name": "TYPE$subexpression$2$subexpression$19", "symbols": [/[fF]/, /[iI]/, /[lL]/, /[eE]/], "postprocess": function (d) {return d.join(""); }},
    {"name": "TYPE$subexpression$2", "symbols": ["TYPE$subexpression$2$subexpression$19"]},
    {"name": "TYPE$subexpression$2$subexpression$20", "symbols": [/[nN]/, /[uU]/, /[mM]/, /[bB]/, /[eE]/, /[rR]/], "postprocess": function (d) {return d.join(""); }},
    {"name": "TYPE$subexpression$2", "symbols": ["TYPE$subexpression$2$subexpression$20"]},
    ...
    {"name": "READONLY$subexpression$1", "symbols": [/[rR]/, /[eE]/, /[aA]/, /[dD]/, /[oO]/, /[nN]/, /[lL]/, /[yY]/], "postprocess": function (d) {return d.join(""); }},
    {"name": "READONLY", "symbols": ["_", "READONLY$subexpression$1", "_", {"literal":"\n"}], "postprocess": function(d){return {key:"readonly", value:true}}},
    {"name": "DISABLED$subexpression$1", "symbols": [/[dD]/, /[iI]/, /[sS]/, /[aA]/, /[bB]/, /[lL]/, /[eE]/, /[dD]/], "postprocess": function (d) {return d.join(""); }},
    {"name": "DISABLED", "symbols": ["_", "DISABLED$subexpression$1", "_", {"literal":"\n"}], "postprocess": function(d){return {key:"disabled", value:true}}},
    ...
    {"name": "ACCEPT$subexpression$1", "symbols": [/[aA]/, /[cC]/, /[cC]/, /[eE]/, /[pP]/, /[tT]/], "postprocess": function (d) {return d.join(""); }},
    {"name": "ACCEPT$ebnf$1", "symbols": [/./]},
    {"name": "ACCEPT$ebnf$1", "symbols": ["ACCEPT$ebnf$1", /./], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "ACCEPT", "symbols": ["_", "ACCEPT$subexpression$1", "__", "ACCEPT$ebnf$1", {"literal":"\n"}], "postprocess": function(d){return {key:"accept", value:d[3].join("")}}},
